...
def FC-traffic-classification(root_normalized_dir,net_params,model_params, 1d-cnn_path,1d-cnn_model,bi-lstm_path,bi-lstm_model,sae_path,sae_model,sae_directory_features,worker_id):
